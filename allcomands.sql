--------------------------------------------------------
--  File created - Wednesday-April-22-2026   
--------------------------------------------------------
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Sequence CONVERSATIONS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CONVERSATIONS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."MESSAGES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CONCERNS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CONCERNS" 
   (	"CONCERN_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"STUDENT_ID" NUMBER, 
	"CATEGORY_ID" NUMBER, 
	"TYPE_ID" NUMBER, 
	...
	"DESCRIPTION" CLOB, 
	"ATTACHMENT_PATH" VARCHAR2(500 BYTE), 
	"PRIORITY" VARCHAR2(20 BYTE) DEFAULT 'Low', 
 ...
 LOB ("DESCRIPTION") STORE AS BASICFILE (
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table CONCERN_TYPES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CONCERN_TYPES" 
   (	"TYPE_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"CATEGORY_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DEPARTMENTS" 
   (	"DEPARTMENT_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Table MAIN_CATEGORIES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."MAIN_CATEGORIES" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table MAIN_PERSONNEL
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."MAIN_PERSONNEL" 
...
--------------------------------------------------------
--  DDL for Table PRIVATE_MESSAGES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PRIVATE_MESSAGES" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."USERS" 
   (	"USER_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"DEPARTMENT_ID" NUMBER, 
	"PROGRAM" VARCHAR2(150 BYTE), 
	"ACCESS_STATUS" VARCHAR2(20 BYTE) DEFAULT 'Active', 
	"IS_VERIFIED" CHAR(1 BYTE) DEFAULT 'N', 
	"CREATED_AT" TIMESTAMP (6) DEFAULT CURRENT_TIMESTAMP, 
	"FORCE_CHANGE" CHAR(1 BYTE) DEFAULT 'N', 
...
REM INSERTING into SYSTEM.ACTIVITY_LOGS
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.CONCERNS
SET DEFINE OFF;
REM INSERTING into SYSTEM.CONCERN_TYPES
SET DEFINE OFF;
REM INSERTING into SYSTEM.CONVERSATIONS
SET DEFINE OFF;
Insert into SYSTEM.CONVERSATIONS (CONVERSATION_ID,USER1_ID,USER2_ID,LAST_MESSAGE_AT) values (2,82,83,to_timestamp('04/21/2026 10:55:58.000000000 AM','MM/DD/RRRR HH12:MI:SSXFF AM'));
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.MAIN_CATEGORIES
SET DEFINE OFF;
REM INSERTING into SYSTEM.MAIN_PERSONNEL
SET DEFINE OFF;
Insert into SYSTEM.MAIN_PERSONNEL (RECORD_ID,SCHOOL_ID,FIRST_NAME,LAST_NAME,EMAIL,CAMPUS,ROLE_TYPE,PROGRAM,DEPARTMENT,IS_ACTIVE) values (1,'20210001','Denise','Lopez','stdnlopez@tip.edu.ph','MNL','STUDENT','BS Information Technology',null,'Y');
Insert into SYSTEM.MAIN_PERSONNEL (RECORD_ID,SCHOOL_ID,FIRST_NAME,LAST_NAME,EMAIL,CAMPUS,ROLE_TYPE,PROGRAM,DEPARTMENT,IS_ACTIVE) values (2,'EMP001','Fernando','Gonzaga','mfgonzaga@tip.edu.ph','QC','EMPLOYEE',null,'IT Services','Y');
Insert into SYSTEM.MAIN_PERSONNEL (RECORD_ID,SCHOOL_ID,FIRST_NAME,LAST_NAME,EMAIL,CAMPUS,ROLE_TYPE,PROGRAM,DEPARTMENT,IS_ACTIVE) values (3,'ADM001','System','Admin1','admin1@tip.edu.ph','MNL','ADMIN',null,'Administration','Y');
REM INSERTING into SYSTEM.MESSAGES
SET DEFINE OFF;
Insert into SYSTEM.MESSAGES (MESSAGE_ID,CONCERN_ID,SENDER_ID,SENT_AT,CONVERSATION_ID) values (8,null,83,to_timestamp('04/21/2026 11:05:51.000000000 AM','MM/DD/RRRR HH12:MI:SSXFF AM'),null);
Insert into SYSTEM.MESSAGES (MESSAGE_ID,CONCERN_ID,SENDER_ID,SENT_AT,CONVERSATION_ID) values (10,null,82,to_timestamp('04/21/2026 11:04:51.000000000 AM','MM/DD/RRRR HH12:MI:SSXFF AM'),null);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PRIVATE_MESSAGES
SET DEFINE OFF;
...
SET DEFINE OFF;
Insert into SYSTEM.ROLES (ROLE_ID,ROLE_NAME) values (1,'STUDENT');
Insert into SYSTEM.ROLES (ROLE_ID,ROLE_NAME) values (2,'MANAGER');
Insert into SYSTEM.ROLES (ROLE_ID,ROLE_NAME) values (3,'ADMIN');
Insert into SYSTEM.ROLES (ROLE_ID,ROLE_NAME) values (4,'SUPER_ADMIN');
...
SET DEFINE OFF;
Insert into SYSTEM.USERS (USER_ID,SCHOOL_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD,ROLE_ID,DEPARTMENT_ID,PROGRAM,ACCESS_STATUS,IS_VERIFIED,CREATED_AT,FORCE_CHANGE,FULL_NAME) values (1,'20210001','Denise','Lopez','stdnlopez@tip.edu.ph','hashed_pass',1,null,'BS Information Technology','Active','Y',to_timestamp('04/15/2026 12:37:04.230000000 AM','MM/DD/RRRR HH12:MI:SSXFF AM'),'N',null);
Insert into SYSTEM.USERS (USER_ID,SCHOOL_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD,ROLE_ID,DEPARTMENT_ID,PROGRAM,ACCESS_STATUS,IS_VERIFIED,CREATED_AT,FORCE_CHANGE,FULL_NAME) values (2,'EMP001','Fernando','Gonzaga','mfgonzaga@tip.edu.ph','hashed_pass',2,null,null,'Active','Y',to_timestamp('04/15/2026 12:37:04.247000000 AM','MM/DD/RRRR HH12:MI:SSXFF AM'),'N',null);
Insert into SYSTEM.USERS (USER_ID,SCHOOL_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD,ROLE_ID,DEPARTMENT_ID,PROGRAM,ACCESS_STATUS,IS_VERIFIED,CREATED_AT,FORCE_CHANGE,FULL_NAME) values (3,'ADM001','System','Admin1','admin1@tip.edu.ph','hashed_pass',3,null,null,'Active','Y',to_timestamp('04/15/2026 12:37:04.258000000 AM','MM/DD/RRRR HH12:MI:SSXFF AM'),'N',null);
Insert into SYSTEM.USERS (USER_ID,SCHOOL_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD,ROLE_ID,DEPARTMENT_ID,PROGRAM,ACCESS_STATUS,IS_VERIFIED,CREATED_AT,FORCE_CHANGE,FULL_NAME) values (82,'2232001','wrio','thesley','asamiyaatsumi077@gmail.com','$2a$10$rLWgRTk369ZOH3zyvH9zxesLfWB/UYfrk8rS3OZBphCcnycqtIV2.',1,null,'BSCS','Active','Y',to_timestamp('04/17/2026 05:50:28.000000000 PM','MM/DD/RRRR HH12:MI:SSXFF AM'),'Y','wrio thesley');
Insert into SYSTEM.USERS (USER_ID,SCHOOL_ID,FIRST_NAME,LAST_NAME,EMAIL,PASSWORD,ROLE_ID,DEPARTMENT_ID,PROGRAM,ACCESS_STATUS,IS_VERIFIED,CREATED_AT,FORCE_CHANGE,FULL_NAME) values (83,'2410003','Fernando','Gonzaga','wrisely077@gmail.com','$2a$10$R3ksLRbURCw53wjtHEUgtO4..9iWmUBSCQdiLpqiVOQxEN57BnR7q',1,null,'BSCS','Active','Y',to_timestamp('04/17/2026 05:51:10.000000000 PM','MM/DD/RRRR HH12:MI:SSXFF AM'),'Y','Fernando Gonzaga');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index UQ_SCHOOL_EMAIL
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."UQ_SCHOOL_EMAIL" ON "SYSTEM"."USERS" ("SCHOOL_ID", "EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_CONVERSATION
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_CONVERSATION" ON "SYSTEM"."PRIVATE_MESSAGES" ("SENDER_ID", "RECIPIENT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_USER2
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_USER2" ON "SYSTEM"."CONVERSATIONS" ("USER2_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_CONCERN_PRIORITY
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_CONCERN_PRIORITY" ON "SYSTEM"."CONCERNS" ("PRIORITY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_MESSAGES_SENDER
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_MESSAGES_SENDER" ON "SYSTEM"."MESSAGES" ("SENDER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_CONCERN_MANAGER
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_CONCERN_MANAGER" ON "SYSTEM"."CONCERNS" ("ASSIGNED_MANAGER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_MESSAGES_SENTAT
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_MESSAGES_SENTAT" ON "SYSTEM"."MESSAGES" ("SENT_AT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_USER1
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_USER1" ON "SYSTEM"."CONVERSATIONS" ("USER1_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_CONCERN_CREATED_AT
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_CONCERN_CREATED_AT" ON "SYSTEM"."CONCERNS" ("CREATED_AT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Index IDX_MESSAGES_CONVERSATION
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_MESSAGES_CONVERSATION" ON "SYSTEM"."MESSAGES" ("CONVERSATION_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  DDL for Index IDX_RECIPIENT
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_RECIPIENT" ON "SYSTEM"."PRIVATE_MESSAGES" ("RECIPIENT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_SENDER
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_SENDER" ON "SYSTEM"."PRIVATE_MESSAGES" ("SENDER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_MESSAGES_CONCERN
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_MESSAGES_CONCERN" ON "SYSTEM"."MESSAGES" ("CONCERN_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_ACTIVITY_CONCERN
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_ACTIVITY_CONCERN" ON "SYSTEM"."ACTIVITY_LOGS" ("CONCERN_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_CONCERN_DEPARTMENT
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_CONCERN_DEPARTMENT" ON "SYSTEM"."CONCERNS" ("DEPARTMENT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_CONCERN_STATUS
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_CONCERN_STATUS" ON "SYSTEM"."CONCERNS" ("STATUS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_SENT_AT
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_SENT_AT" ON "SYSTEM"."PRIVATE_MESSAGES" ("SENT_AT") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_CONCERN_STUDENT
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_CONCERN_STUDENT" ON "SYSTEM"."CONCERNS" ("STUDENT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Trigger CONVERSATIONS_TRIGGER
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."CONVERSATIONS_TRIGGER" 
BEFORE INSERT ON conversations
FOR EACH ROW
BEGIN
    SELECT conversations_seq.NEXTVAL INTO :NEW.conversation_id FROM dual;
END;
/
ALTER TRIGGER "SYSTEM"."CONVERSATIONS_TRIGGER" ENABLE;
--------------------------------------------------------
--  DDL for Trigger MESSAGES_TRIGGER
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."MESSAGES_TRIGGER" 
...
/
ALTER TRIGGER "SYSTEM"."MESSAGES_TRIGGER" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRG_UPDATE_CONCERN
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."TRG_UPDATE_CONCERN" 
...
END;
/
ALTER TRIGGER "SYSTEM"."TRG_UPDATE_CONCERN" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CONCERN_TYPES" MODIFY ("TYPE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERN_TYPES" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERN_TYPES" MODIFY ("TYPE_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERN_TYPES" ADD PRIMARY KEY ("TYPE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ROLES" MODIFY ("ROLE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ROLES" MODIFY ("ROLE_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ROLES" ADD PRIMARY KEY ("ROLE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."ROLES" ADD UNIQUE ("ROLE_NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CONVERSATIONS" MODIFY ("USER1_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONVERSATIONS" MODIFY ("USER2_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONVERSATIONS" ADD PRIMARY KEY ("CONVERSATION_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CONVERSATIONS" ADD UNIQUE ("USER1_ID", "USER2_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PRIVATE_MESSAGES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRIVATE_MESSAGES" MODIFY ("SENDER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRIVATE_MESSAGES" MODIFY ("RECIPIENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRIVATE_MESSAGES" MODIFY ("MESSAGE_TEXT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRIVATE_MESSAGES" MODIFY ("SENT_AT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRIVATE_MESSAGES" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("CONCERN_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("STUDENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("TYPE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("DEPARTMENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("DESCRIPTION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("PRIORITY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("STATUS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" MODIFY ("CREATED_AT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONCERNS" ADD CONSTRAINT "CHK_PRIORITY" CHECK (priority IN ('Low','Medium','High','Critical')) ENABLE;
  ALTER TABLE "SYSTEM"."CONCERNS" ADD CONSTRAINT "CHK_STATUS" CHECK (status IN ('Pending','In Progress','Closed')) ENABLE;
  ALTER TABLE "SYSTEM"."CONCERNS" ADD PRIMARY KEY ("CONCERN_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" )  ENABLE;
--------------------------------------------------------
--  Constraints for Table MAIN_PERSONNEL
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" MODIFY ("RECORD_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" MODIFY ("SCHOOL_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" MODIFY ("FIRST_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" MODIFY ("LAST_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" MODIFY ("CAMPUS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" MODIFY ("ROLE_TYPE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" MODIFY ("IS_ACTIVE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" ADD CONSTRAINT "CHK_MAIN_ROLE" CHECK (role_type IN ('STUDENT','EMPLOYEE','ADMIN')) ENABLE;
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" ADD CONSTRAINT "CHK_MAIN_CAMPUS" CHECK (campus IN ('MNL','QC')) ENABLE;
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" ADD CONSTRAINT "CHK_MAIN_ACTIVE" CHECK (is_active IN ('Y','N')) ENABLE;
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" ADD PRIMARY KEY ("RECORD_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" ADD UNIQUE ("SCHOOL_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."MAIN_PERSONNEL" ADD UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."DEPARTMENTS" ADD UNIQUE ("DEPARTMENT_NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."DEPARTMENTS" ADD UNIQUE ("MANAGER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MAIN_CATEGORIES" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_CATEGORIES" MODIFY ("CATEGORY_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MAIN_CATEGORIES" ADD PRIMARY KEY ("CATEGORY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."MAIN_CATEGORIES" ADD UNIQUE ("CATEGORY_NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MESSAGES" MODIFY ("MESSAGE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MESSAGES" MODIFY ("SENDER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MESSAGES" MODIFY ("MESSAGE_TEXT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MESSAGES" MODIFY ("SENT_AT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MESSAGES" ADD PRIMARY KEY ("MESSAGE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ACTIVITY_LOGS" MODIFY ("LOG_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ACTIVITY_LOGS" MODIFY ("CONCERN_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ACTIVITY_LOGS" MODIFY ("ACTION_BY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ACTIVITY_LOGS" MODIFY ("ACTION_TYPE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ACTIVITY_LOGS" MODIFY ("ACTION_TIME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ACTIVITY_LOGS" ADD PRIMARY KEY ("LOG_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USERS" MODIFY ("SCHOOL_ID" NOT NULL ENABLE);
  ...
  ALTER TABLE "SYSTEM"."USERS" MODIFY ("ROLE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USERS" MODIFY ("ACCESS_STATUS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USERS" MODIFY ("IS_VERIFIED" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USERS" MODIFY ("CREATED_AT" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USERS" ADD CONSTRAINT "CHK_ACCESS_STATUS" CHECK (access_status IN ('Active','Suspended')) ENABLE;
  ALTER TABLE "SYSTEM"."USERS" ADD CONSTRAINT "CHK_IS_VERIFIED" CHECK (is_verified IN ('Y','N')) ENABLE;
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."USERS" ADD CONSTRAINT "UQ_SCHOOL_EMAIL" UNIQUE ("SCHOOL_ID", "EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."USERS" MODIFY ("FORCE_CHANGE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ACTIVITY_LOGS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ACTIVITY_LOGS" ADD CONSTRAINT "FK_LOG_USER" FOREIGN KEY ("ACTION_BY")
	  REFERENCES "SYSTEM"."USERS" ("USER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."ACTIVITY_LOGS" ADD CONSTRAINT "FK_LOG_CONCERN" FOREIGN KEY ("CONCERN_ID")
	  REFERENCES "SYSTEM"."CONCERNS" ("CONCERN_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CONCERNS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CONCERNS" ADD CONSTRAINT "FK_CONCERN_STUDENT" FOREIGN KEY ("STUDENT_ID")
	  REFERENCES "SYSTEM"."USERS" ("USER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."CONCERNS" ADD CONSTRAINT "FK_CONCERN_CATEGORY" FOREIGN KEY ("CATEGORY_ID")
	  REFERENCES "SYSTEM"."MAIN_CATEGORIES" ("CATEGORY_ID") ENABLE;
  ALTER TABLE "SYSTEM"."CONCERNS" ADD CONSTRAINT "FK_CONCERN_TYPE" FOREIGN KEY ("TYPE_ID")
	  REFERENCES "SYSTEM"."CONCERN_TYPES" ("TYPE_ID") ENABLE;
  ALTER TABLE "SYSTEM"."CONCERNS" ADD CONSTRAINT "FK_CONCERN_DEPARTMENT" FOREIGN KEY ("DEPARTMENT_ID")
	  REFERENCES "SYSTEM"."DEPARTMENTS" ("DEPARTMENT_ID") ENABLE;
  ALTER TABLE "SYSTEM"."CONCERNS" ADD CONSTRAINT "FK_CONCERN_MANAGER" FOREIGN KEY ("ASSIGNED_MANAGER_ID")
	  REFERENCES "SYSTEM"."USERS" ("USER_ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CONCERN_TYPES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CONCERN_TYPES" ADD CONSTRAINT "FK_TYPE_CATEGORY" FOREIGN KEY ("CATEGORY_ID")
	  REFERENCES "SYSTEM"."MAIN_CATEGORIES" ("CATEGORY_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CONVERSATIONS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CONVERSATIONS" ADD FOREIGN KEY ("USER1_ID")
	  REFERENCES "SYSTEM"."USERS" ("USER_ID") ENABLE;
  ALTER TABLE "SYSTEM"."CONVERSATIONS" ADD FOREIGN KEY ("USER2_ID")
	  REFERENCES "SYSTEM"."USERS" ("USER_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DEPARTMENTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DEPARTMENTS" ADD CONSTRAINT "FK_DEPT_MANAGER" FOREIGN KEY ("MANAGER_ID")
	  REFERENCES "SYSTEM"."USERS" ("USER_ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table MESSAGES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MESSAGES" ADD CONSTRAINT "FK_MSG_CONCERN" FOREIGN KEY ("CONCERN_ID")
	  REFERENCES "SYSTEM"."CONCERNS" ("CONCERN_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."MESSAGES" ADD CONSTRAINT "FK_MSG_SENDER" FOREIGN KEY ("SENDER_ID")
	  REFERENCES "SYSTEM"."USERS" ("USER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."MESSAGES" ADD CONSTRAINT "FK_MESSAGES_CONVERSATION" FOREIGN KEY ("CONVERSATION_ID")
	  REFERENCES "SYSTEM"."CONVERSATIONS" ("CONVERSATION_ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_ROLLUP" ADD CONSTRAINT "MVIEW$_ADV_ROLLUP_PFK" FOREIGN KEY ("RUNID#", "PLEVELID#")
	  REFERENCES "SYSTEM"."MVIEW$_ADV_LEVEL" ("RUNID#", "LEVELID#") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PRIVATE_MESSAGES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PRIVATE_MESSAGES" ADD CONSTRAINT "FK_SENDER" FOREIGN KEY ("SENDER_ID")
	  REFERENCES "SYSTEM"."USERS" ("USER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "SYSTEM"."PRIVATE_MESSAGES" ADD CONSTRAINT "FK_RECIPIENT" FOREIGN KEY ("RECIPIENT_ID")
	  REFERENCES "SYSTEM"."USERS" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USERS" ADD CONSTRAINT "FK_USERS_ROLE" FOREIGN KEY ("ROLE_ID")
	  REFERENCES "SYSTEM"."ROLES" ("ROLE_ID") ENABLE;
